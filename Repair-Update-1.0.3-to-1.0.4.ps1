...
function Resolve-PackagePath {
    ...
    $updateDirectory = Join-Path $env:LOCALAPPDATA "RA-Compagnon\updates\$Version"
    ...
    throw "Aucun package local pour la version $Version n'a été trouvé dans $updateDirectory."
}
...
$resolvedPackagePath = Resolve-PackagePath -RequestedPackagePath $PackagePath -Version $Version
...
Write-Step "Réparation 1.0.3 -> $Version terminée."
